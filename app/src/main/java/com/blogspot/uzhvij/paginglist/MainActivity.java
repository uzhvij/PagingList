...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FilmDataFactory factory = new FilmDataFactory(new FilmStorage(this));
        ...
        LiveData<PagedList<Film>> pagedListLiveData = new LivePagedListBuilder(factory, config).
                setFetchExecutor(Executors.newSingleThreadExecutor())
                .build();

        adapter = new FilmRecycleViewAdapter(Film.DIFF_CALLBACK);

        pagedListLiveData.observe(this, new Observer<PagedList<Film>>() {
            @Override
